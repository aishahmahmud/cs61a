...
def free_bacon(score):
    ...
    they recieve 2 more than the absolute difference between the digits
    in the opponent's total score.
    """
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    def score_opp(player):
        if player==0:
            return score1
        else:
            return score0

    def new_score(player,turn_score):
    ...
    while score0 < goal and score1<goal:
        ...
        opponent_score= score_opp(player)
        #strategy of the player
        player_strategy= strategy(player)
        #a score for each turn
        turn_score=take_turn(player_strategy(player_score,opponent_score),opponent_score,dice)
        #update your score
        new_score(player, turn_score)
...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    def say(score0, score1):
        ...
        return announce_highest(who, previous_score=score, previous_high=)
    return say
    # END PROBLEM 7
...
def difference(scorenow,scorebefore):
